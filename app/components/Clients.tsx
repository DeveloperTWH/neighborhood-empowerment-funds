            ...
            <div className="flex flex-col md:flex-row gap-12 mt-10">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="relative w-64 sm:w-72 md:w-96 h-36 sm:h-40 md:h-48">
                        {[getNeighborIndex(-1), activeIndex, getNeighborIndex(1)].map((index, i) => (
                            <div
                                key={i}
                                ref={photoRefs[i]}
                ...
                <div className="">
                    <div
                        ref={contentRef}
                        className="flex-1 bg-white rounded-xl opacity-100 mb-10"
                        key={activeIndex}
                    >
                        ...
                        <div>
                            <p className="font-semibold text-gray-900 text-xl">{testimonials[activeIndex].name}</p>
